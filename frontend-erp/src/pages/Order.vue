  ...
  >
    ...
    <template v-if="slideoutMode === 'add' || slideoutMode === 'edit'">
      <form class="flex flex-col gap-4">
        <MyInputField label="Order Code" v-model="form.code" placeholder="ORD-XXX" />
        <MyInputField label="Customer" v-model="form.customer" placeholder="Customer Name" />
        <MyInputField label="Email" v-model="form.email" placeholder="Email Address" />
        <MyInputField label="Date" v-model="form.date" type="date" />
        <MyInputField label="Items" v-model="form.items" type="number" placeholder="Items" />
        <MyInputField label="Total" v-model="form.total" type="number" placeholder="Total Amount" />
        <MyDropdown label="Payment" v-model="form.payment" :options="payments.slice(1)" placeholder="Select Payment" />
        <MyDropdown label="Status" v-model="form.status" :options="statuses.slice(1)" placeholder="Select Status" />
      </form>
    </template>
